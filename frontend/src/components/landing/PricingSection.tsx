...
const PLANS = [
  ...
  },
  {
    ...
    period: 'one-time',
    credits: 25,
    features: ['25 credits', 'Basic priority queue', 'All templates unlocked', 'Story Mode included'],
    cta: 'Buy Basic',
    highlight: false,
  },
  {
    ...
    period: 'one-time',
    credits: 125,
    features: ['125 credits', 'Mid priority queue', 'Faster generation', 'Best value per credit'],
    cta: 'Buy Mid',
    highlight: true,
  },
  {
    ...
    period: 'one-time',
    credits: 400,
    features: ['400 credits', 'Top priority queue', 'Fastest generation', 'For power users'],
    cta: 'Buy Pro',
    highlight: false,
  },
]
